...
const spaceTexture = new THREE.TextureLoader().load('https://github.com/Asvo777/3D-Space-Website/blob/main/img/space.jpg');
scene.background = spaceTexture;

const jeffTexture = new THREE.TextureLoader().load('https://github.com/Asvo777/3D-Space-Website/blob/main/img/jeff.png');
...
const earthTexture = new THREE.TextureLoader().load('https://github.com/Asvo777/3D-Space-Website/blob/main/img/earth.jpg');
